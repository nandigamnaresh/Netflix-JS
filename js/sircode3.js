...
//                  //    document.getElementById('ptag').innerHTML = n;
...
function focusEvent() {
    document.getElementById("input-one").style.border = "2px solid red";
}

function keydownEvent() {
    document.getElementById("input-two").style.border = "2px solid red";
    document.getElementById("input-two").style.backgroundColor = "yellow";
}

function blurEvent() {
    document.getElementById("input-three").style.backgroundColor = "red";
