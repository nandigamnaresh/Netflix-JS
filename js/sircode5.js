...
//         if(this.readyState==2)
//         {
//             document.getElementById('displayy').innerHTML="Ok Ok"
//         }
...
//         else
//             {
//                 document.getElementById("a").innerHTML=" i think the code is wrong.........";
//             };
...
//                 var data=JSON.parse(xhttp.responseText);
//                 document.getElementById("a").innerHTML=data.branch;
...
//                 var data=JSON.parse(xhttp.responseText);
//                 document.getElementById("a").innerHTML=data.location;
