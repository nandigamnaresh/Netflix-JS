var clothing = [
  ...
  clothingContainer.classList.add("clothing-container");
  
  var accessoriesContainer = document.createElement("div");
  container.appendChild(accessoriesContainer);
  accessoriesContainer.classList.add("accessories-container");
  
  var clothingTitle = document.createElement("h2");
  clothingContainer.appendChild(clothingTitle);
  clothingTitle.innerText = "Clothing for Men and Women";
  
  var accessoriesTitle = document.createElement("h2");
  accessoriesContainer.appendChild(accessoriesTitle);
  accessoriesTitle.innerText = "Accessories for Men and Women";
  
  var clothingSection = document.createElement("div");
  clothingContainer.appendChild(clothingSection);
  
  var accessoriesSection = document.createElement("div");
  accessoriesContainer.appendChild(accessoriesSection);
  
  clothingSection.classList.add("clothing-section");
  accessoriesSection.classList.add("accessories-section");
  
  var clothingContent = "";
  
  for (var i = 0; i < clothing.length; i++) {
    clothingContent += "<div class='main-card'>";
    clothingContent += "<div class='image'>";
    clothingContent += "<img src='" + clothing[i].preview + "'></img>";
    clothingContent += "</div>";
    clothingContent += "<div class='text-content'>";
    clothingContent += "<h3>" + clothing[i].name + "</h3>";
    clothingContent += "<h4>" + clothing[i].brand + "</h4>";
    clothingContent += "<p>" + clothing[i].price + "</p>";
    clothingContent += "</div>";
    clothingContent += "</div>";
    clothingContent += "</div>";
  }
  
  clothingSection.innerHTML = clothingContent;
  
  var accessoriesContent = "";
  
  for (var j = 0; j < accessories.length; j++) {
    accessoriesContent += "<div class='main-card'>";
    accessoriesContent += "<div class='image'>";
    accessoriesContent += "<img src='" + accessories[j].preview + "'></img>";
    accessoriesContent += "</div>";
    accessoriesContent += "<div class='text-content'>";
    accessoriesContent += "<h3>" + accessories[j].name + "</h3>";
    accessoriesContent += "<h4>" + accessories[j].brand + "</h4>";
    accessoriesContent += "<p>" + accessories[j].price + "</p>";
    accessoriesContent += "</div>";
    accessoriesContent += "</div>";
    accessoriesContent += "</div>";
  }
  
  accessoriesSection.innerHTML = accessoriesContent;